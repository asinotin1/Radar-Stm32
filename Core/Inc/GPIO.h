...
typedef struct{
	...
	union{
		...
		struct{
		  ...
		  volatile 	uint32_t BSR3:1;
		  volatile 	uint32_t BSR4:1;
		  volatile 	uint32_t BSR5:1;
		  volatile 	uint32_t BSR6:1;
		  volatile 	uint32_t BSR7:1;
		  volatile 	uint32_t BSR8:1;
		  volatile 	uint32_t BSR9:1;
		  volatile 	uint32_t BSR10:1;
		  volatile 	uint32_t BSR11:1;
		  volatile 	uint32_t BSR12:1;
		  volatile 	uint32_t BSR13:1;
		  volatile 	uint32_t BSR14:1;
		  volatile 	uint32_t BSR15:1;
